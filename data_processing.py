...
for country,x0, departures, x1, x2, x3, x4, x5, x6, x7, x8, x9 in data_departures_df:
...
for idx in range(5,len(data_all_city_internal) + 5):
    country_name=data_flight_global_week_df[0][idx]
...
# 外国输入中国的输出国家风险矩阵保存位置 todo 这里还没修改
